...
if __name__ == '__main__':
    ...
    print("\nEndpoints de Avatar:")
    print("  POST /api/avatar/process_audio  - Procesa audio y convierte a texto")
    print("  POST /api/avatar/text_to_sign   - Convierte texto a secuencia de señas")
    print("  GET  /api/avatar/available_signs - Lista de señas disponibles")
    print("  GET  /api/avatar/keypoints      - Obtiene keypoints de una seña")
    print("="*50)
